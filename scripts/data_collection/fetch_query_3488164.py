#!/usr/bin/env python3
"""Fetch results from Dune query #3488164 - CSV endpoint (no execution cost)"""
...
print("Fetching Results from Query #3488164")
print("=" * 60)
print("⚠️  Using CSV endpoint - NO execution cost!")
print("=" * 60)

try:
    # Fetch using CSV endpoint (cheap - just downloads existing results)
    ...
    output_path = Path("data/processed/ethereum_active_addresses_3488164.csv")
